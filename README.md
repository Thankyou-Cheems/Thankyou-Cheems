...
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=2800&pause=1200&color=58A6FF&center=true&vCenter=true&repeat=true&width=540&height=52&lines=Hi%2C+I%27m+Ruikang+%28Karl%29+Wang" alt="Typing SVG" />
</a>

Incoming Master's (Fall 2026)
...
**[Bomana](https://github.com/Thankyou-Cheems/Bomana)** — War Thunder SB mode timer and bomb-drop predictor.  
Python + Win32 overlay, using `localhost:8111` for real-time telemetry and navigation support.
...
![Ink](https://img.shields.io/badge/Ink-React_TUI-61DAFB?style=flat)
![Mermaid](https://img.shields.io/badge/Mermaid-Diagrams-FF3670?style=flat)
![Puppeteer](https://img.shields.io/badge/Puppeteer-40B5A4?style=flat&logo=puppeteer&logoColor=white)

### Learning Intensively

- `Policy-as-code` and sandbox validation
- `Terminal graphics protocols (Sixel, iTerm2 inline image, Kitty graphics)`
- `Image/render pipeline tuning (Sharp, node-canvas, Streaming I/O)`
